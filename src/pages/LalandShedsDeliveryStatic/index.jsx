...
export default function LalandShedsDeliveryStatic() {
    return (
        <Box className="flex flex-wrap flex-col large_desktop:flex-row justify-between px3 depx-100 py-54 gap-50 laptop:gap-20">
            ...
            <Box className="flex-1">
                ...
                <Box className="bg-tooltip !w-fit mt-30 mx-auto">
                    <iframe 
                        width="425" 
                        height="239" 
                        src="https://www.youtube.com/embed/ojWoCnY_GzE" 
                        title="Shed Delivery of a Basic Shed with the Mule - Lelands Barns and Sheds" 
                        frameborder="0" 
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
                        allowfullscreen 
                        className="large_desktop:min-w-425 !laptop:min-w-300 max-w-full"
                    />
                </Box>
            </Box>
        </Box>
