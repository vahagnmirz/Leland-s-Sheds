...
export default function RentToOwn() {
    return (
        <>
            <Box className="flex flex-wrap justify-between px3 depx-100 py-54 gap-100">
                <Box className="desktop:max-w-600">
                    ...
                    <Box className="!mt-35 !mb-20 rounded-4 shadow-card p-20">
                        <Typography className="capitalize !font-medium !text-xl text-red">
                            What is a rent to own program?
                        </Typography>
                    </Box>
                    <Typography className="!font-medium !mt-10 !text-xs px-20">
                    ...
                    <Typography className="!font-medium !mt-30 !text-base px-20">
                        Bankruptcy:
                    </Typography>
                    <Typography className="!font-medium !mt-10 !text-xs px-20">
                    ...
                    <Box className="!mt-50 !mb-20 rounded-4 shadow-card p-20">
                        <Typography className="capitalize !font-medium !text-xl text-red">
                ...
                <Box className="desktop:max-w-600">
                    ...
                    <Box className="!mt-35 !mb-20 rounded-4">
                        <img 
                            src={'assets/Images/rent.jpg'}
                            alt='Logo'
                            className='block !w-full drop-shadow-rentImg'
                        />
                    </Box>
                    ...
                    <Typography className="!font-medium !text-xs px-20">
                    ...
                    <Typography className="!font-medium !mt-30 !text-xs px-20">
                    ...
                    <Typography className="!font-medium !mt-10 !text-base px-20">
                        Improvements:
                    </Typography>
                    <Typography className="!font-medium !mt-10 !text-xs px-20">
